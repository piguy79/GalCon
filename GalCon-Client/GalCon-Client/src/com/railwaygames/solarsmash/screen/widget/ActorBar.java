...
public class ActorBar extends Group {
	...
	public ActorBar(float height, float width, int alignment, Collection<Actor> actors, float actorHeight,
			float actorWidth, float actorPadding) {
		this.height = height;
		this.width = width;
