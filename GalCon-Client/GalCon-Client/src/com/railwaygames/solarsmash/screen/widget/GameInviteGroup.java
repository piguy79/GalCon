...
public class GameInviteGroup extends Group {
	...
	public GameInviteGroup(Resources resources, GameQueueItem item, Size size, String mapTitle){
	...
	private void createLevelLabel() {
		final ShaderLabel levelLabel = new ShaderLabel(resources.fontShader, " Map: " + mapTitle,
