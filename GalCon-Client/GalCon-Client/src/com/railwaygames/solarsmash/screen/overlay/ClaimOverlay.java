...
public class ClaimOverlay extends Overlay {
	...
	private void addClaimButton() {
		...
		claimButton = new CommonTextButton(resources.skin, "Claim Victory", buttonHeight, buttonWidth,
	...
	private void addContinueButton() {
		CommonTextButton continueButton = new CommonTextButton(resources.skin, "Continue Game", buttonHeight,
				buttonWidth, resources.fontShader);
