...
public class CommonFacebookRequests {
	...
	public static FacebookRequest publishFeed(String name, String caption, String description, String message,
			String pictureUrl, String link, String token, boolean showDialog, FacebookRequestListener listener) {
		...
		Foundation.log("FB token" + token);

		return new FacebookRequest("me/feed", parameters, HttpMethod.POST, showDialog, listener);
	}

	public static FacebookRequest publishFeedToFriend(String to, String name, String caption, String description,
			String message, String pictureUrl, String link, String token, boolean showDialog,
	...
	public static FacebookRequest invite(String title, String message, List<String> invitedIds,
			FacebookRequestListener listener) {
		HashMap<String, String> parameters = new HashMap<String, String>();
